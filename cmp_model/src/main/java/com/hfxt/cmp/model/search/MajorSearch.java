 ...
 */
public class MajorSearch extends BaseSearch {
	 ...
	 * dbValue == thisValue
	 */
    private String eqMajorName;
    /**
	 * dbValue like %thisValue%
	 */
    private String lkMajorName;
    /**
     *product_id(10,0)
	 * dbValue == thisValue
	 */
    private Integer eqProductId;
     /**
	 * dbValue <> thisValue
	 */
    ...
    public String getEqMajorName() {
        return eqMajorName;
    }
    public String getLkMajorName() {
        return lkMajorName;
    }
    
    public Integer getEqProductId() {
        return eqProductId;
    }
	...
	public void setEqMajorName(String eqMajorName) {
		this.eqMajorName = eqMajorName;
	}
    public void setLkMajorName(String lkMajorName) {
		this.lkMajorName = lkMajorName;
	}
    public void setEqProductId(Integer eqProductId) {
		this.eqProductId = eqProductId;
	}
