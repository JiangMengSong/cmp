...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pro}/major/majorList.html" data-title="专业管理" href="javascript:void(0)">专业管理</a></li>
                    <li><a data-href="${pro}/subject/subjectList.html" data-title="课程管理" href="javascript:void(0)">课程管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
